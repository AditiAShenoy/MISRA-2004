...
static void name_67_xff_xxxxxxxxxxxxxxxxx31b ( void ); /* Not Compliant */
static void name_71_xvf_xxxxxxxxxxxxxxxxx31b ( void ); /* Not Compliant */
static void mc2_0501_x1 ( void );

void name_65_xfxf_xxxxxxxxxxxxxxxx31a ( void )         /* Not Compliant */
{
   use_int32 ( 0 ); /* Do Something */
}

void name_65_xfxf_xxxxxxxxxxxxxxxx31b ( void )         /* Not Compliant */
{
   use_int32 ( 0 ); /* Do Something */
}

void name_66_xfxv_xxxxxxxxxxxxxxxx31a ( void )         /* Not Compliant */
{
   use_int32 ( 0 ); /* Do Something */
}

void name_67_xff_xxxxxxxxxxxxxxxxx31a ( void )         /* Not Compliant */
{
   use_int32 ( 0 ); /* Do Something */
}
...
void name_69_xfv_xxxxxxxxxxxxxxxxx31a ( void )         /* Not Compliant */
{
   use_int32 ( 0 ); /* Do Something */
}
...
int32_t name_66_xfxv_xxxxxxxxxxxxxxxx31b = 0;          /* Not Compliant */

int32_t name_68_xvxv_xxxxxxxxxxxxxxxx31a = 0;          /* Not Compliant */

int32_t name_68_xvxv_xxxxxxxxxxxxxxxx31b = 0;          /* Not Compliant */

int32_t name_70_xvv_xxxxxxxxxxxxxxxxx31a = 0;          /* Not Compliant */

static int32_t name_70_xvv_xxxxxxxxxxxxxxxxx31b = 0;   /* Not Compliant */

int32_t name_71_xvf_xxxxxxxxxxxxxxxxx31a = 0;          /* Not Compliant */

static int32_t name_69_xfv_xxxxxxxxxxxxxxxxx31b = 0;   /* Not Compliant */
