...
void mc2_0502 ( void )
{
   struct tag_hide { int32_t memb; } t_hide = { 0 };
   int32_t var_hide = get_int32 ( );
   int32_t var_enum_hide = get_int32 ( );
   enum
   {
      hidden_enumerated
   } enum_var_hide, enum_hide, enum_type_hide;
   typedef int32_t typedef_hide;
   typedef int32_t type_enum_hide;
   typedef int32_t type_var_hide;
   int32_t var_type_hide  = get_int32 ( );
   ...
   {
      struct tag_hide t_hide;          /* Not Compliant - Tag hidden by Tag */
      int32_t var_hide;                /* Not Compliant - Int hides Int */
      int32_t enum_var_hide;           /* Not Compliant - Int hides Enum */
      enum
      {
         hidden_enumerated
      }                                /* Not Compliant */
      var_enum_hide,                   /* Not Compliant - Enum hides Int */
      enum_hide,                       /* Not Compliant - Enum hides Enum */
      type_enum_hide;                  /* Not Compliant - Enum hides Typedef */
      int32_t type_var_hide;           /* Not Compliant - Int hides Typedef */
      int32_t mc2_0502a;               /* Not Compliant - Int hides Function */
      enum
      {
         mc2_0502b
      }                                /* Not Compliant */
      enum_func_hide;                  /* Not Compliant - Enum hides Function */
      int32_t local_hide_extern;       /* Not Compliant - Local var hides extern
                                                          from header */
      typedef int32_t enum_type_hide;  /* Not Compliant - Typedef hides Enum */
      typedef int32_t var_type_hide;   /* Not Compliant - Typedef hides Int */
      typedef int32_t mc2_0502c;       /* Not Compliant - Typedef hides Function */
